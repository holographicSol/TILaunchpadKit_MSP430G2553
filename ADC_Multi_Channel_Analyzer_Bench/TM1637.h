...
// Prototypes
void TM1637_init(const int enable, const int brightness);
void TM1637_display_colon(const int value);
void TM1637_set_brightness(const int value);
void TM1637_display_digit(const int position, const int digit);
...
void TM1637_display_segments(const int position, const int segments);
