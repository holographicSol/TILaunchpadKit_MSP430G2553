...
#define TM1637_DIO_HIGH()       (P2OUT |= _BV(TM1637_DIO_PIN))  // Sets data line high/low
#define TM1637_DIO_LOW()        (P2OUT &= ~_BV(TM1637_DIO_PIN))
#define TM1637_DIO_OUTPUT()     (P2DIR |= _BV(TM1637_DIO_PIN)) // Sets data line in/out
#define TM1637_DIO_INPUT()      (P2DIR &= ~_BV(TM1637_DIO_PIN))
#define TM1637_DIO_READ()       (((P2IN & _BV(TM1637_DIO_PIN)) > 0) ? 1 : 0) // Reads data line
