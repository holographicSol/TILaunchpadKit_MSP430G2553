/*
 * AJoyStick - Nano Standard - Written by Benjamin Jack Cullen
 *
...
void interpret_joy(int adc_a, int adc_b, int adc_c){
    if      (adc_a  <=  500) {x0=1; x1=0; y0=0; y1=0;}                        // left
    else if (adc_a  >=  510) {x0=0; x1=1; y0=0; y1=0;}                        // right
    else if (adc_b  <=  535) {x0=0; x1=0; y0=1; y1=0;}                        // up
    else if (adc_b  >=  545) {x0=0; x1=0; y0=0; y1=1;}                        // down
